...
// Start new chats and Foci on credits, so the conductor and its workers all run
...
// A Focus, and a conductor turn that dispatches three workers at once.
await page.click('#new-focus-btn');
