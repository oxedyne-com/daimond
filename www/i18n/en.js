...
(function () {
	...
	'marks.waiting.one': '{n} folder was marked on another device or before 23 September, so it is not in force on this device.',
	'marks.waiting.other': '{n} folders were marked on another device or before 23 September, so they are not in force on this device.',
	'marks.waiting_why': 'A mark now applies only on the device it was made or confirmed on. Nothing here can change what is in a folder below until you confirm it on this device.',
