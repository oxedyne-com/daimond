...
/// Focus/brief/`.daimond` storage is unaffected — it pins the OPFS sandbox.
#[wasm_bindgen]
...
/// definition in [`crate::wasm::focus`] rather than duplicating the wording
/// in JavaScript, where it would drift.
#[wasm_bindgen]
pub fn worker_prompt() -> String {
    crate::wasm::focus::WORKER_PROMPT.to_string()
}
